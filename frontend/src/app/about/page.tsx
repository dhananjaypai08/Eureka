          ...
          <div className="mb-16">
            <div className="relative p-8 rounded-xl bg-gradient-to-b from-gray-900 to-black border border-gray-800 shadow-xl">
              ...
              <div className="relative">
                <div className="absolute top-0 bottom-0 left-6 w-0.5 bg-gradient-to-b from-blue-500 to-purple-600"></div>
                
                <h3 className="text-xl font-medium mb-6 text-white">The Hunt Process:</h3>
                
                <div className="space-y-8 relative">
                  <div className="ml-12 relative">
                    <div className="absolute -left-12 mt-1 w-6 h-6 rounded-full bg-blue-500 flex items-center justify-center">
                  ...
                  <div className="ml-12 relative">
                    <div className="absolute -left-12 mt-1 w-6 h-6 rounded-full bg-indigo-500 flex items-center justify-center">
                  ...
                  <div className="ml-12 relative">
                    <div className="absolute -left-12 mt-1 w-6 h-6 rounded-full bg-purple-500 flex items-center justify-center">
                  ...
                  <div className="ml-12 relative">
                    <div className="absolute -left-12 mt-1 w-6 h-6 rounded-full bg-pink-500 flex items-center justify-center">
