...
import { ClueHunt } from "../components/ClueHunt";
...
export const LocationRequest = () => {
    ...
    // If location has been successfully acquired, render the ClueHunt component
    if (status === "success" && userLocation) {
      return <ClueHunt userLocation={userLocation} />;
    }
