    ...
    <div className="min-h-screen bg-black text-white">
      ...
      {!gameStarted ? (
        <div className="flex flex-col items-center justify-center min-h-screen p-8 text-center">
          ...
          <div className="fixed top-20 left-20 w-72 h-72 bg-blue-500/20 rounded-full filter blur-3xl opacity-20 animate-pulse"></div>
          <div className="fixed bottom-20 right-20 w-72 h-72 bg-purple-500/20 rounded-full filter blur-3xl opacity-20 animate-pulse" style={{ animationDelay: "1s" }}></div>
          <div className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-pink-500/10 rounded-full filter blur-3xl opacity-10 animate-pulse" style={{ animationDelay: "2s" }}></div>
          ...
          <div className="relative z-10 max-w-3xl">
            ...
            <h1 className="text-5xl sm:text-6xl md:text-7xl font-bold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-blue-400 via-purple-500 to-pink-500">
              ZK Location Hunt
            </h1>
            ...
            <div className="space-y-4 sm:space-y-0 sm:space-x-4 flex flex-col sm:flex-row justify-center items-center">
              ...
              <a 
                href="/about" 
                className="px-8 py-4 rounded-lg border border-gray-700 hover:bg-gray-800 text-gray-300 font-medium transition-all w-full sm:w-auto flex items-center justify-center"
              >
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                  <circle cx="12" cy="12" r="10"></circle>
            ...
            <div className="mt-16 grid grid-cols-1 sm:grid-cols-3 gap-8 text-left">
              <div className="bg-gray-900/50 p-6 rounded-xl border border-gray-800">
                ...
                <p className="text-gray-400 text-sm">Your location data never leaves your device thanks to zero-knowledge proofs.</p>
              </div>
              ...
              <div className="bg-gray-900/50 p-6 rounded-xl border border-gray-800">
                ...
                <h3 className="text-lg font-semibold mb-2 text-white">Verified Completion</h3>
                <p className="text-gray-400 text-sm">Cryptographic proof of your achievements without revealing your path.</p>
              </div>
              ...
              <div className="bg-gray-900/50 p-6 rounded-xl border border-gray-800">
                ...
                <h3 className="text-lg font-semibold mb-2 text-white">On-Chain Rewards</h3>
                <p className="text-gray-400 text-sm">Earn digital collectibles on Base blockchain for each location you discover.</p>
              </div>
            </div>
          </div>
